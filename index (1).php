...
if($row>0)
{
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,birth_date) values('$fname','$lname','$email','$enc_password','$contact','$birth_date')");
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<input type="text" value="" name="contact"  required>
                                                                                                                 <p align="left">
                                                                                                                <label for="dateofbirth" style="color:#FFFFFF;font-size:100%;font-family:raleway;">Date of Birth</label>
                                                                                                                <input type="date" value="" name="date of birth" required>
                                                                                                                </p>
